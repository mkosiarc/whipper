...
class OverrideFileSelectorTest {
  ...
  public void findFileInBaseDirTest() {
      assertEquals(testObj.getExpectedResultFile(testFileinBase.getName()), testFileinBase, "unexpected file returned");
  }
  ...
  public void findFileSameNameInDirsTest() {
      assertEquals(testObj.getExpectedResultFile("sameFileName"), overrideDirsFilesSameName[2], "unexpected file returned");
  }
}