...
class OverrideFileSelectorTest {
  ...
  public void findFileInBaseDirTest() {
      assertEquals(testObj.getExpectedResultFile(testFileinBase.getName()), testFileinBase, "unexpected file retured");
  }

  @Test
  public void findFileNonExistentFileTest() {
      assertEquals(testObj.getExpectedResultFile("madeUpFile"), null, "unexpected value retured");
  }

  @Test
  public void findFileInOverrideDirTest() {
      for (File file : overrideDirsFiles) {
          assertEquals(testObj.getExpectedResultFile(file.getName()), file, "unexpected file retured");
      }
  }

  @Test
  public void findFileIfDirTest() {
      assertEquals(testObj.getExpectedResultFile(testDir.getName()), null, "unexpected file retured");
  }

  @Test
  public void findFileSameNameInDirsTest() {
      assertEquals(testObj.getExpectedResultFile("sameFileName"), overrideDirsFilesSameName[2], "unexpected file retured");
  }
}